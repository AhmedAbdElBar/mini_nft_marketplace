...
import 'package:mini_nft_marketplace/feature/status/widgets/custom_button_for_ranking.dart';
...
class CustomRankingWidget extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Expanded(
      child: Padding(
        padding: const EdgeInsets.all(PaddingValueManager.vP15),
        child: Column(
          children: [
            const Row(
              mainAxisAlignment: MainAxisAlignment.spaceAround,
              children: [
                CustomButtonForRanking(
                  title: StringsValueManager.vSAllCategories,
                ...
                CustomButtonForRanking(
                  title: StringsValueManager.vSAllChains,
                  icon: Icons.link,
                )
              ],
            ),
                    ...
                    child: ListView.separated(
                        ...
                        itemBuilder: (context, index) =>
                            CustomCardForRankingPage(
                              ...
                              percentage:
                                  Constants.rankingList[index].percentage,
                            ),
                        separatorBuilder: (context, index) => const SizedBox(
                              height: HeightValueManager.vH5,
                            ),
